{{-- (Kode ini sama persis dengan yang saya berikan sebelumnya, hanya dipindahkan ke file terpisah) --}}
                                    ...
                                    <div class="md:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-3">
                                        <div>
                                            ...
                                            <select :name="'drawings[' + drawing.id + '][status]'" :id="'status_' + drawing.id" class="mt-1 block w-full py-1 px-2 border border-gray-300 rounded-md text-sm" required>
                                                <option value="approved">Disetujui</option><option value="revision">Revisi</option><option value="rejected">Ditolak</option>
                                            </select>
                                        </div>
                                        <div>
