...
class DailyLogController extends Controller
{
    ...
    public function store(Request $request, Package $package)
	{
		try {
			...
			// Logika untuk menyimpan rincian tenaga kerja
			...
			// Logika untuk menyimpan material
			...
			// Logika untuk menyimpan peralatan
			...
			// Menitipkan pesan sukses ke session
    ...
    {
        $validatedData = $request->validate([
            'rab_item_id' => 'required|exists:rab_items,id', // Sekarang divalidasi
